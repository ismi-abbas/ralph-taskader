...
interface TaskDialogProps {
  task: (Task & { comments: (Comment & { author: { name: string | null; image: string | null } })[]; ralphPlan: RalphPlan | null }) | null
  isOpen: boolean
  onClose: () => void
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside text-blue-700 space-y-1">
                    {(task.ralphPlan.implementationPlan as Array<{ step: number; title: string; description: string; files: string[] }>).map((step, i: number) => (
                      <li key={i}>
